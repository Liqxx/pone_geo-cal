...
string=87
dom=84
$metaproject/env-shell.sh python /home/fhenningsen/pone/pone_geo-cal/generation/simple_POCAM_simulation.py --gcd-file=$gcd  --output-i3-file="${file_name}" --number-of-photons=$phot --number-of-runs=$N --string=$string --dom=$dom --ice-tables=$water_tables
