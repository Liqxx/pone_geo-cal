...
# Here, we define the 5 key parameters or rather define the lists of parameters we want to iterate throughV
ice_shift_abs=$3
ice_shift_sca=$4
dom_eff_corr=$5
p0_ang_acc=$6
...
ice_tables="/home/fhenningsen/osc/deepcore_systematics/icemodel/tmp/tmp-a$3-b$4-de$5-p0$6-p1$7"
mkdir $ice_tables
cp ${ice_default}/* ${ice_tables}/.

# Multiplying the offset to the icemodel parameters:
$metaproject/env-shell.sh python /home/fhenningsen/deepcore_systematics/mod_scripts/change_ice.py --a_corr=$ice_shift_abs --b_corr=$ice_shift_sca --outfile=${ice_tables}/icemodel.dat
...
python /home/fhenningsen/deepcore_systematics/mod_scripts/dima_from_unified.py "$p0_ang_acc" "$p1_ang_acc" "$ice_tables/as.dat"
